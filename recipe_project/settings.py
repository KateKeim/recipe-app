...
ALLOWED_HOSTS = [
    'https://guarded-depths-24786-07aeaa68a258.herokuapp.com/', '127.0.0.1', 'guarded-depths-24786-07aeaa68a258.herokuapp.com']
...
# The local filesystem path where media files are stored
MEDIA_ROOT = 'media'
